...
class RmsAlg:
    ...
    def calc_difference(self, s, sprime):
        ...
        return difference if difference <= self.influence else math.inf
    ...
    def update(self, s, r, sprime, sprime_features=None):
        ...
        :param r: la recompensa de la transición
        ...
        # verifica que el estado esté en la lista de conocidos
